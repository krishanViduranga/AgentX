      ...
      <section className="w-full py-24 relative overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto px-4 md:px-6 flex flex-col items-center text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
            Join thousands of individuals, families, and advisors who are planning smarter, faster, and more securely with AgentX — your AI assistant for life and financial strategies.
          </p>
